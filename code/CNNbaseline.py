...
from tensorflow.keras.layers import Conv1D, MaxPooling1D,Dense, Embedding, SpatialDropout1D, Flatten
...
model = Sequential()
model.add(Embedding(MAX_NB_WORDS, EMBEDDING_DIM, input_length=165))
